...
func NewCountService() bt.Service {
	...
	s.NewCharacteristic(uuid.MustParse("11fac9e0-c111-11e3-9246-0002a5d5c51b")).HandleRead(
	...
	s.NewCharacteristic(uuid.MustParse("16fe0d80-c111-11e3-b8c8-0002a5d5c51b")).HandleWrite(
		bt.WriteHandlerFunc(func(req bt.Request, rsp bt.ResponseWriter) {
			log.Printf("count: Wrote %s", string(req.Data()))
		}))

	s.NewCharacteristic(uuid.MustParse("1c927b50-c116-11e3-8a33-0800200c9a66")).HandleNotify(
	...
	s.NewCharacteristic(uuid.MustParse("2da38c61-c116-11e3-8a33-0800200c9a66")).HandleNotify(
